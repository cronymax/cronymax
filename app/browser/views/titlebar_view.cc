...
CefRefPtr<CefPanel> TitleBarView::Build() {
  ...
  panel->SetBackgroundColor(kTitleBarBgFallback);
  ...
  lights_pad_->SetBackgroundColor(kTitleBarBgFallback);
  ...
  // 1b. Sidebar toggle.
  {
    ...
    btn_sidebar_toggle_->SetBackgroundColor(kTitleBarBgFallback);
  ...
  // 1c. Space selector.
  {
    ...
    btn_space_->SetBackgroundColor(kTitleBarBgFallback);
  ...
  spacer_->SetBackgroundColor(kTitleBarBgFallback);
  ...
  auto add_btn = [&](CefRefPtr<CefLabelButton> *slot, IconId icon,
    ...
    btn->SetBackgroundColor(kTitleBarBgFallback);
    panel->AddChildView(btn);
    layout->SetFlexForView(btn, 0);
    *slot = btn;
  };
  add_btn(&btn_web_, IconId::kTabWeb, "Web", "New web tab", "web");
  add_btn(&btn_term_, IconId::kTabTerminal, "Terminal", "New terminal",
          "terminal");
  ...
  // 5. Windows-controls slot (zero width on macOS).
  win_pad_ =
      CefPanel::CreatePanel(new SizedPanelDelegate(CefSize(kWinPadW, 1)));
  win_pad_->SetBackgroundColor(kTitleBarBgFallback);
