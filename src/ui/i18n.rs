...
const EN_US: &[(&str, &str)] = &[
    ...
    ("chat.start_thread", "Start a thread from this block"),
    ("chat.view_thread", "View thread"),
    ("chat.back_to_parent", "← Back to parent"),
    ("chat.thread_from", "Thread from: {0}"),
    ("chat.thread_summary", "⑂ Thread · {0} messages"),
    // ── Settings ──
    ...
    ("cmd.new_tab", "Open new chat tab"),
    ("cmd.close_tab", "Close current tab"),
...
const ZH_CN: &[(&str, &str)] = &[
    ...
    ("chat.start_thread", "从此块启动话题"),
    ("chat.view_thread", "查看话题"),
    ("chat.back_to_parent", "← 返回父会话"),
    ("chat.thread_from", "话题来自：{0}"),
    ("chat.thread_summary", "⑂ 话题 · {0} 条消息"),
    // ── Settings ──
    ("settings.general", "通用"),
    ...
    ("cmd.close", "关闭活动网页视图"),
    ("cmd.new_tab", "打开新终端标签页"),
    ("cmd.close_tab", "关闭当前标签页"),
    ("cmd.filter", "切换输出筛选模式"),
