...
Provide an Arc-style browser experience with Space-scoped tab groups, pinned tabs, session tabs, persistent tab state, and an agent-accessible browser tool.
