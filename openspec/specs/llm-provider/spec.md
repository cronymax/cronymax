...
Provide an OpenAI-compatible LLM client with streaming, tool-call parsing, and configurable base URL/API key so the agent runtime can call cloud or local model servers.
