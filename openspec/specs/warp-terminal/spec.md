...
Provide a Warp-style terminal with shell-integration command-block parsing, persistent block history, and AI Fix/Explain actions that hand off to the agent runtime.
