...
Execute agent graphs (LLM, Tool, Condition, Human, Subgraph nodes) in the renderer using a ReAct loop with tool calls, permission gates, subgraph composition, and command-block-driven task creation.
